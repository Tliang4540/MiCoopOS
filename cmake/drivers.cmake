...
if(${CHIP} MATCHES "STM32")
    ...
    if(${CHIP} MATCHES "STM32G0")
        set(DRIVERS_SRC ${DRIVERS_SRC} drivers/stm32/flash/flash_g0.c)
    endif()
endif()

if (BSP_USING_SPIFLASH)
    set(DRIVERS_SRC ${DRIVERS_SRC} drivers/spiflash/spiflash.c)
endif()
...
target_include_directories(driverslib PUBLIC drivers/include)
